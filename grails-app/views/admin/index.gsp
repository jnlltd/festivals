...
<div class="container main">
    ...
    <ul class="spaced">
        ...
        <li>
            <g:link action="listUnapprovedReviews">Moderate Reviews</g:link>.
            ${reviewCount} unapproved review(s) are awaiting moderation. Unapproved reviews are not
            displayed on the site until they're approved.
        </li>
