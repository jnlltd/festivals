...
testDataConfig {
    sampleData {
        ...
        // provide values for properties that have custom validators and unique constraints because the plugin
        ...
        'ie.festivals.User' {
            ...
            def i = 1
            username = {-> "foo${i++}@bar.com" }
        }

        'ie.festivals.Festival' {
            start = new Date() - 10
            end = new Date() + 10

            longitude = 0
            latitude = 0
            type = FestivalType.HEADLINE
            countryCode = 'irl'
            city = 'Dublin'
        }
    }
