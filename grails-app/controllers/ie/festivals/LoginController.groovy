...
class LoginController {
	...
	/**
	 * Default action; redirects to '/' if logged in, /login/auth otherwise.
	 */
	def index() {
	...
	def authfail() {
		...
		if (exception) {
			if (exception instanceof AccountExpiredException) {
				...
				flashHelper.warn "springSecurity.errors.login.locked"
                redirect controller: 'register', action: 'newUser'
                return
			}
			else {
